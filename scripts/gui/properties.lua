...
function edi_init_properties()
	...
	editor.gui.properties.edit.entity.mat_name_lab = edi_create_label(editor.gui.properties.handle, "mat_name_lab", 4, 260, "Name", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_diffuse_lab = edi_create_label(editor.gui.properties.handle, "mat_diffuse_lab", 4, 282, "Diffuse", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_specular_lab = edi_create_label(editor.gui.properties.handle, "mat_specular_lab", 4, 326, "Specular", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_ambient_lab = edi_create_label(editor.gui.properties.handle, "mat_ambient_lab", 4, 348, "Ambient", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_spec_power_lab = edi_create_label(editor.gui.properties.handle, "mat_spec_power_lab", 4, 370, "Spec Power", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_lighting_lab = edi_create_label(editor.gui.properties.handle, "mat_lighting_lab", 4, 392, "Lighting", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_prlx_scale_lab = edi_create_label(editor.gui.properties.handle, "prlx_scale_lab", 4, 414, "Prlx Scale", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_alpha_test_lab = edi_create_label(editor.gui.properties.handle, "alpha_test_lab", 4, 436, "Alpha Test", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_alpha_thrs_lab = edi_create_label(editor.gui.properties.handle, "alpha_thrs_lab", 4, 458, "Alpha Thrs", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_diffuse_map_lab = edi_create_label(editor.gui.properties.handle, "diffuse_map_lab", 4, 480, "Diffuse Map", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_normal_map_lab = edi_create_label(editor.gui.properties.handle, "normal_map_lab", 4, 502, "Normal Map", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_height_map_lab = edi_create_label(editor.gui.properties.handle, "height_map_lab", 4, 524, "Height Map", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_spec_map_lab = edi_create_label(editor.gui.properties.handle, "spec_map_lab", 4, 546, "Spec Map", editor.gui.fonts.normal)
	editor.gui.properties.edit.entity.mat_light_map_lab = edi_create_label(editor.gui.properties.handle, "light_map_lab", 4, 568, "Light Map", editor.gui.fonts.normal)

	editor.gui.properties.edit.entity.model_txf = edi_create_text_field(editor.gui.properties.handle, "texture_txf", 99, 48, "images/text_field128", editor.gui.fonts.normal, "")

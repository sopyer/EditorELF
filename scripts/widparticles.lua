...
function ediInitWidParticles()
	...
	widParticles.delayAttr = ediCreateFloatGroupAttribute(widParticles.object, "Delay", 4, 142, 0, nil, "", 1, "SetParticlesSpawnDelay")
	...
	widParticles.rotationAttr = ediCreateFloatGroupAttribute(widParticles.object, "Rotation", 4, 222, 0, nil, "", 2, "SetParticlesRotation")
	widParticles.rotGrowAttr = ediCreateFloatGroupAttribute(widParticles.object, "Rot Grow", 4, 242, 0, nil, "", 2, "SetParticlesRotationGrowth")
...
function ediUpdateWidParticlesSelection()
	...
	ediSetFloatGroupAttributeValues(widParticles.delayAttr, {GetParticlesSpawnDelay(sel)})
...
function ediUpdateWidParticles()
	...
	ediUpdateAttribute(widParticles.delayAttr, sel)
